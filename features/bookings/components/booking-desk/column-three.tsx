...
import { Receipt, CreditCard, Banknote, Smartphone, Link, Terminal, Edit2, Tag, Check, X } from "lucide-react";
...
export function ColumnThree({ currentRates, paxCounts, paymentState, setPaymentState }: ColumnThreeProps) {
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-left-4 duration-500 delay-200">
            {/* Header */}
