...
export function ColumnOne({ availability, onStateChange, saveRef }: ColumnOneProps) {
    ...
    return (
        <div className="flex flex-col h-full bg-transparent">
            {/* Fixed Header */}
            <div className="shrink-0 px-6 py-4 bg-background/95 backdrop-blur-md border-b border-border sticky top-0 z-10 space-y-4 supports-[backdrop-filter]:bg-background/60">
                <div className="flex flex-col gap-0.5">
                    <div className="text-lg font-bold text-foreground uppercase tracking-wider truncate" title={availability.experience_name || ""}>
                ...
                <div className="space-y-3">
                    <div className="text-sm font-bold text-muted-foreground uppercase tracking-wider mb-2">Session Details</div>
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <div className="text-muted-foreground text-sm uppercase font-bold tracking-wider">Date</div>
                            <div className="text-foreground font-medium">
                                {formatDate(availability.start_date)}
                            </div>
                        </div>
                        <div>
                            <div className="text-muted-foreground text-sm uppercase font-bold tracking-wider">Time</div>
                            <div className="text-foreground font-medium">
                ...
                <div className="space-y-3 border-t border-border pt-4">
                    <div className="text-sm font-bold text-muted-foreground uppercase tracking-wider mb-2">Transportation & Staff</div>
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <div className="text-muted-foreground text-sm uppercase font-bold tracking-wider">Route</div>
                            <div className="text-foreground font-medium truncate">
                                {availability.route_name || "—"}
                            </div>
                        </div>
                        <div>
                            <div className="text-muted-foreground text-sm uppercase font-bold tracking-wider">Vehicle</div>
                            <div className="text-foreground font-medium truncate">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <div className="text-muted-foreground text-sm uppercase font-bold tracking-wider">Driver</div>
                            <div className="text-foreground font-medium truncate">
                                {availability.driver_name || "—"}
                            </div>
                        </div>
                        <div>
                            <div className="text-muted-foreground text-sm uppercase font-bold tracking-wider">Guide</div>
                            <div className="text-foreground font-medium truncate">
            ...
            <div className="flex-1 overflow-y-auto p-0 space-y-0 custom-scrollbar animate-in fade-in slide-in-from-left-4 duration-500">
                ...
                <div className="px-6 py-3 border-b border-border bg-muted/30 backdrop-blur-sm sticky top-0 z-10 w-full mb-6 relative">
                ...
                <div className="px-6 pb-6 space-y-4">
                    ...
                    <div className="space-y-2">
                        <Label className="text-muted-foreground text-sm uppercase font-bold tracking-wider">
                            Private Note
                        </Label>
                        <Textarea
                            value={headline}
                            onChange={(e) => setHeadline(e.target.value)}
                            className="bg-muted/50 border-input text-foreground placeholder:text-muted-foreground focus-visible:border-primary/50 min-h-[80px] text-base"
