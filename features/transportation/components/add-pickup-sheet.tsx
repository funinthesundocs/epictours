            ...
            <form onSubmit={handleSubmit(onSubmit)} className="h-full flex flex-col">
                <div className="flex-1 overflow-y-auto p-6 custom-scrollbar pb-24 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        {errors.map_link && <p className="text-xs text-destructive">{errors.map_link.message}</p>}
                    </div>
                ...
                <div className="shrink-0 flex justify-end items-center gap-4 py-4 px-6 border-t border-border mt-auto bg-background">
                    <Button
                        type="submit"
